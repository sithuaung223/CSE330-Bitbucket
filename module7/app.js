...
.controller('ReviewListCtrl', ['$scope','$routeParams', function ($scope,$routeParams) {
  var coffeeId= $routeParams.coffeeId;
   $scope.coffees=
    ...
    $scope.reviews= $scope.coffees[coffeeId-1].reviews;
}])

.controller('CoffeeListCtrl', ['$scope',function ($scope) {
   $scope.coffees =
       [
       {'id': 1,
       'brand': "Average Andy's Coffee",
